...
var (
	...
	U_1e17    = uint256.MustFromDecimal("100000000000000000")
	...
	MaxGamma    = uint256.MustFromDecimal("20000000000000000")
	MinA        = number.Div(number.Mul(number.Number_4, AMultiplier), number.Number_10) // 4 = NCoins ** NCoins
	MaxA        = number.Mul(number.Mul(number.Number_4, AMultiplier), uint256.MustFromDecimal("100000"))
