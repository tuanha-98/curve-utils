...
func Test_GeometricMean_For_TwoCrypto(t *testing.T) {
	...
	if GeometricMean(x, false, &calculatedMean) != nil {
		t.Fatalf("geometricMean failed")
	}
...
func Test_GeometricMean_For_TriCrypto(t *testing.T) {
	var calculatedMean, expectedMean uint256.Int
	expectedMean.SetFromDecimal("17671000109279529")
...
func Test_NewtonY_For_TwoCrypto(t *testing.T) {
	var i = 0
	...
	err := Newton_y(&A, &gamma, xp, &D, i, calculatedY)
	if err != nil {
...
func Test_NewtonY_For_TriCrypto(t *testing.T) {
	var i = 0
	var A, gamma, precision, D, dx, expectedY uint256.Int
	A.SetFromDecimal("1707629")
	gamma.SetFromDecimal("11809167828997")
...
func Test_ReductionCoefficient_For_TwoCrypto(t *testing.T) {
...
func Test_ReductionCoefficient_For_TriCrypto(t *testing.T) {
	var feeGamma, precision uint256.Int
	feeGamma.SetFromDecimal("300000000000000000")
	precision.SetFromDecimal("1000000000000000000")
